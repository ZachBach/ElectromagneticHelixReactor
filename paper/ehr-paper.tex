...
% ORCID carried as a footnote via hyperref's \href (already loaded above), so
% no extra package is needed. This .tex is the only source of truth for the
% paper — no PDF is committed; build with `tectonic paper/ehr-paper.tex`.
